const CommentBox = () => {
  return (
    <form className="w-full ">
      ...
      <button className="flex items-center  bg-gradient-to-r from-[#c94ff8] to-[#a803e2] duration-200 transition ease-linear  hover:bg-gradient-to-l px-8 py-[12px] text-lg text-white rounded-[35px] mt-8">
        Comment
      </button>
    </form>
  );
