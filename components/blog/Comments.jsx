const Comments = () => {
  return (
    <div className="rounded-lg mt-6 bg-gradient-to-r from-[#c94ff8] to-[#a803e2] p-[1px] mr-3">
      <div className=" dark:bg-[#232220] bg-[#ffffff]   flex  p-4 rounded-lg  ">
        ...
        <div className="pl-5">
          ...
          <button className="dark:text-[#dedede] text-tiny hover:text-[#c94ff8] dark:hover:text-[#c94ff8]">
            Reply
          </button>
        </div>
      </div>
